...
let $doc := doc('../../../BauDi/baudi-data/editions/baudi-14-2b84beeb/criticalAnnots/baudi-kantate-kb-SVOrch-00.xml')
...
let $remarksNew := for $remark at $i in $remarks
    ...
    return
        $remarkNew
    return
        <crApp xmlns="http://baumann-digital.de/ns/crApp" xml:id="crApp-file-ID">
